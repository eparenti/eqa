...
class BrowserClient:
    ...
    def __init__(self, screenshots_dir: Optional[Path] = None):
        ...
        Args:
            screenshots_dir: Directory for screenshots (default: ~/.cache/exercise-qa-2/screenshots/)
        """
        self.screenshots_dir = screenshots_dir or Path.home() / ".cache" / "exercise-qa-2" / "screenshots"
