#!/usr/bin/env python3
"""
Exercise QA 3 - Main Entry Point
...
class ExerciseQA:
    ...
    def run(self):
        ...
        self._print(self.colors.header("Exercise QA 3"))
        self._print(self.colors.bold("=" * 70))
        ...
        # Step 5: Run student simulation (Phase 1)
    ...
    def _save_student_reports(self, results: list):
        ...
        output_dir = Path.home() / ".claude" / "skills" / "exercise-qa-3" / "results"
...
def parse_args():
    ...
    parser = argparse.ArgumentParser(
        description="Exercise QA 3 - Professional automated course testing"
    )
    ...
    parser.add_argument(
        '-o', '--output',
        type=str,
        help='Output directory or file path (default: ~/.claude/skills/exercise-qa-3/results/)'
    )
